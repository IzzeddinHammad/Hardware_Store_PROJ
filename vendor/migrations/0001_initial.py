...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('PayPal', 'PayPal'), ('Stripe', 'Stripe'), ('AIB Bank Account', 'AIB Bank Account'), ('Bank of Ireland Account', 'Bank of Ireland Account'), ('Permanent TSB Bank Account', 'Permanent TSB Bank Account')], default='PayPal', max_length=50, null=True)),
